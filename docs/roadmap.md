...
Все базовые потоки (Stage 8 + 8.5 Dashboard v2, SPEC-016 canonical conversion, SPEC-017 категории, SPEC-018 линза) закрыты. На проде также весь пост-MVP: Stage 5b sparklines (SPEC-021), бюджеты (SPEC-020/023), инвестиции (Stage 9 — SPEC-026…030), виртуализация списков (SPEC-034), статистика Mini App (SPEC-036). В работе сейчас ничего нет; открыты только: Stage 10 (AI Coach), мобильный ввод дохода/снапшота (2.3), график прогресса цели (2.5, NG2 SPEC-018), keyset-пагинация (по триггеру).
...
- Stage 5b (step-chart баланса ведра, остаток), Stage 10 (AI Coach), график прогресса цели (2.5, NG2 SPEC-018), keyset-пагинация длинных списков (по триггеру).
