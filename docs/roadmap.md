...
Между этапами. Stage 8 + 8.5 (Dashboard v2), SPEC-016 (canonical conversion) и SPEC-017 (управление категориями) закрыты. Следующее на выбор: Stage 5b (графики снапшотов), Stage 9 (инвестиции), Stage 10 (AI Coach), виртуализация длинных списков.
