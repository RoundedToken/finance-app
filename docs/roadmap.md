...
### Stage 9 — Инвестиции ✅ (крипто-портфель, SPEC-026/027/028/029 — на проде)
...
- ✅ Выбор периода графика (SPEC-029): спарклайн позиции настраивается по окну (12м/6м/год/всё/период) — паритет с дашбордом; `PeriodPresets` вынесен в общий компонент.
