...
Тотал тренд +6%/мес (рост уровня жизни реален). Архетипы по данным: Жильё→fixed (CoV0.07); Еда/Продукты/Досуг→recurring (CoV 0.41/0.50/0.66); Коммуналка→seasonal/recurring (CoV0.53); Техника/Одежда/Дом→lumpy (CoV 1.99/1.85/2.35); Подписки/Чаевые→intermittent. Кросс-категорийный профицит vs P75 ≈ €2053/год (для линзы Фазы 4). Симуляция: плоский EWMA → ратчет-ловушка; damped-Holt держит реальность (Еда: лимит €520→491 за 3 мес экономии, настоящие спайки помечаются корректно).
