...
- 2026-07-07: `done` — PR #36 (`93f3165`) смержен, задеплоено на прод (Pages), харнесы light+dark зелёные, скриншоты просмотрены (Runway без спарклайна, бейджи при disabled-гриде, Δ-подпись).
